...
public interface ISessionObserver {
     ...
     * @param sessionId
     */
    void onSessionStart(long id, @NonNull String sessionId);
     ...
     * @param appLog
     */
    void onSessionTerminate(long id, @NonNull String sessionId, @Nullable JSONObject appLog);
     ...
     * @param appLog
     */
    void onSessionBatchEvent(long id, @NonNull String sessionId, @Nullable JSONObject appLog);
}
